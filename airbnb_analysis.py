...
st.set_page_config(page_title="AirBnb-Analysis by SUVALAKSHMI!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"SUVALAKSHMI"}')
    mail = (f'{"Mail :"}  {"suvalakshmi419@gmail.com"}')
    social_media = {
        "GITHUB": "https://github.com/VSuvalakshmi/VSuvalakshmi.git",
        "LINKEDIN": "https://www.linkedin.com/in/suvalakshmi-v-0601101ab/"}

    col1, col2 = st.columns(2)
    col1.image(Image.open("C:\\Users\\SWETHA\\OneDrive\\Desktop\\IMG-20200328-WA0018~2.jpg"), width=300)
